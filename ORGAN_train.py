...
parser.add_argument('--conf', type=str,default="configs/colon.yaml")
parser.add_argument('--output_dir', type=str, default='/data/ORGAN')
...
shutil.copy(args.conf, os.path.join(output_directory, 'colon.yaml'))
